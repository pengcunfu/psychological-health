...
def upload_file():
    ...
    try:
        ...
        return json_success(file_info, '文件上传成功')

    except ValueError as e:
        return json_error(str(e))
    except RequestEntityTooLarge:
        return json_error('文件大小超过限制')
    except Exception as e:
        return json_error(f'上传失败: {str(e)}')
...
def upload_avatar():
    ...
    try:
        ...
        if file_ext not in allowed_extensions:
            return json_error(f'不支持的文件格式，仅支持: {", ".join(allowed_extensions)}')
        ...
        return json_success(file_info, '头像上传成功')
...
def upload_banner():
    ...
    try:
        ...
        return json_success(file_info, '横幅图上传成功')
...
def upload_course_cover():
    ...
    try:
        ...
        return json_success(file_info, '课程封面上传成功')
...
def upload_course_video():
    ...
    try:
        ...
        return json_success(file_info, '课程视频上传成功')
...
def upload_assessment():
    ...
    try:
        ...
        return json_success(file_info, '测评封面上传成功')
