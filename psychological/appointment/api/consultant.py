...
def get_consultant_detail(consultant_id):
    ...
    return json_success(consultant_dict)
...
def create_consultant(form):
    ...
    db.session.commit()
    return json_success(consultant.to_dict(), '咨询人创建成功')
...
def update_consultant(consultant_id, form):
    ...
    try:
        db.session.commit()
        return json_success(consultant.to_dict(), '咨询人更新成功')
...
def delete_consultant(consultant_id):
    ...
    try:
        ...
        db.session.commit()
        return json_success(message='咨询人删除成功')
    except Exception as e:
        db.session.rollback()
...
def set_default_consultant(consultant_id):
    ...
    try:
        ...
        return json_success(consultant.to_dict(), '默认咨询人设置成功')
    except Exception as e:
        db.session.rollback()
        return json_error(f'设置失败: {str(e)}')
