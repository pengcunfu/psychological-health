...
class Config:
    ...
    DATABASE_URI: str = 'mysql+pymysql://root:123456@localhost:3306/psychological_health?charset=utf8mb4'
    CORS_ORIGINS: str = '*'
    domain: str = ''
...
def get_config():
    ...
    if not os.path.exists(config_path):
        ...
        return {
            ...
            'database_uri': 'mysql+pymysql://app_user:app_password@localhost:3306/psychological_health?charset=utf8mb4',
            'cors_origins': '*',
            'domain': '',
            'code': {
