<template>
  <view class="container">
    ...
    <view class="tab-section">
      ...
      <view class="tab-item" :class="{ active: activeTab === 'course' }" @click="switchTab('course')">
        课程
      </view>
    </view>
    ...
    <view class="content-section">
      ...
      <view v-if="activeTab === 'course'">
        <view v-if="courses.length > 0">
          <view class="course-card" v-for="(item, index) in courses" :key="index" @click="navigateToCourse(item.id)">
            <image class="course-image" :src="item.cover || '/static/images/default-course.png'" mode="aspectFill">
            </image>
