<template>
  <view class="container">
    <view class="form-section">
      ...
      <view class="current-info">
        <view class="info-item">
          ...
          <text class="info-value">{{ maskPhone(currentPhone) }}</text>
        </view>
      </view>
        ...
        <view class="form-item">
          ...
          <view class="verify-code-input">
            ...
            <button 
              ...
              :disabled="form.counting || !form.phone" 
              @click="sendCode"
            >
      ...
      <view class="tips">
        <text class="tip-item">• 请确保新手机号可以正常接收短信</text>
    ...
    <view class="submit-section">
      <button class="submit-btn" @click="handleChangePhone">
        确认更换
      </button>
    </view>
  </view>
