...
export { roleAPI, menuAPI, groupAPI, statsAPI, settingAPI, uploadAPI, getRoles, getRole, createRole, updateRole, deleteRole, getDiseaseTags, getDiseaseTag, createDiseaseTag, updateDiseaseTag, deleteDiseaseTag, getWorkspaces, getWorkspace, createWorkspace, updateWorkspace, deleteWorkspace } from './system'
...
export default {
    ...
    uploadAPI: () => import('./system').then(m => m.uploadAPI),
