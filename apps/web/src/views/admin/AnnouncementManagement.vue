<template>
  <div class="announcement-management">
    ...
    <div class="search-and-action-bar">
      <a-form layout="inline" :model="searchForm" @submit="handleSearch" class="search-form">
        <a-form-item label="公告标题">
          <a-input v-model:value="searchForm.title" placeholder="请输入公告标题" style="width: 200px;" />
        </a-form-item>
        ...
        <a-form-item label="类型">
          <a-select v-model:value="searchForm.type" placeholder="请选择类型" style="width: 150px;" allow-clear>
    ...
    <!-- 公告列表 -->
    <a-table :columns="columns" :data-source="announcements" :loading="loading" :pagination="pagination"
    ...
    <a-modal v-model:open="modalVisible" :title="modalTitle" @ok="handleModalOk" @cancel="handleModalCancel"
      width="800px" :body-style="{ maxHeight: '70vh', overflowY: 'auto' }">
      <a-form ref="announcementFormRef" :model="announcementForm" :rules="announcementFormRules" layout="vertical">
        ...
        <a-row :gutter="16">
          <a-col :span="12">
            <a-form-item label="生效时间" name="start_time">
              <a-date-picker v-model:value="announcementForm.start_time" show-time placeholder="请选择生效时间"
                style="width: 100%;" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="失效时间" name="end_time">
              <a-date-picker v-model:value="announcementForm.end_time" show-time placeholder="请选择失效时间"
                style="width: 100%;" />
            </a-form-item>
          </a-col>
        </a-row>
        ...
        <a-form-item label="公告摘要" name="summary">
          <a-textarea v-model:value="announcementForm.summary" placeholder="请输入公告摘要（选填）" :rows="2" />
        </a-form-item>

        <a-form-item label="公告内容" name="content">
          <a-textarea v-model:value="announcementForm.content" placeholder="请输入公告详细内容" :rows="8" />
        </a-form-item>

        <a-form-item label="是否置顶" name="is_pinned">
          <a-switch v-model:checked="announcementForm.is_pinned" checked-children="是" un-checked-children="否" />
        </a-form-item>
      </a-form>
    </a-modal>

    <!-- 查看公告详情弹窗 -->
    <a-modal v-model:open="viewModalVisible" title="公告详情" :footer="null" width="700px">
